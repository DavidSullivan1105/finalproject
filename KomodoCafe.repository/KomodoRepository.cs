...
namespace KomodoCafe.repository
{
    public class KomodoRepository
    {
        ...
        List<string> _newMealIngredients = new List<string>();
        //Create
        ...
        {
            Menu italian = new Menu( 1, "When in Rome", "A classic italian sub w/ a side and drink", "ham , salami, oil & vinegar" , 8.99m, Sides.Fries, Drinks.Lemonade);
